...
class LineLeaderInRepairTicketsListAdapter constructor(
    val viewModel: LineLeaderInRepairTicketsViewModel,
    val languageJsonObject: JSONObject
)
    : RecyclerView.Adapter<LineLeaderInRepairTicketsListAdapter.ViewHolder>() {

    var index = -1
    var data = listOf<InRepairTicket>()
        set(value) {
            field = value
    ...
    class ViewHolder private constructor(val binding: ListItemInRepairTicketsBinding, val languageJsonObject: JSONObject) : RecyclerView.ViewHolder(binding.root) {

        fun bind(item: InRepairTicket) {
        ...
        companion object {
            fun from(parent: ViewGroup, languageJsonObject: JSONObject): ViewHolder {
                ...
                val binding = ListItemInRepairTicketsBinding.inflate(layoutInflater, parent, false)
