...
class LineLeaderReportedTicketsListAdapter constructor(
    val viewModel: LineLeaderReportedTicketsViewModel,
    val languageJsonObject: JSONObject
)
    : RecyclerView.Adapter<LineLeaderReportedTicketsListAdapter.ViewHolder>() {
