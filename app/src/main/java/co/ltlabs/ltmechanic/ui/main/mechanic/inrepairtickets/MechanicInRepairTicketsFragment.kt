...
import co.ltlabs.ltmechanic.databinding.FragmentMechanicInRepairTicketsBinding
...
import co.ltlabs.ltmechanic.ui.adapter.MechanicInRepairTicketsListAdapter
...
class MechanicInRepairTicketsFragment : BaseFragment() {

    @Inject
    lateinit var languageJsonObject: JSONObject

    private val viewModel: MechanicInRepairTicketsViewModel by viewModels { providerFactory }
    ...
    private lateinit var binding: FragmentMechanicInRepairTicketsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMechanicInRepairTicketsBinding.inflate(inflater)
        ...
        val adapter = MechanicInRepairTicketsListAdapter(viewModel, languageJsonObject)
        ...
        ticketViewModel.inRepairTickets.observe(viewLifecycleOwner, Observer { reportedTickets ->
            ...
            if (it != null && it.isNotEmpty()) {
                ...
                when (it[0].action) {
                    ...
                    SNACK_BAR_ACTION_INSERT -> {
                        if (it[0].show) {
//                            binding.coordinatorLayout.showSnackbar("Station ${args.addMachineStation} ${args.addMachineMachine} has been added")
...
//                            val message = "Line ${args.addMachineMachine} ${args.addMachineStation} has been replaced"
    ...
    private fun navigateToTicketPreview(
        ...
        val action = MechanicInRepairTicketsFragmentDirections
            .actionMechanicInRepairTicketsFragmentToMechanicInRepairTicketsPreviewFragment(
                ticketId,
                ticketNo,
                machineNo,
                problem,
    ...
    private fun navigateToCreateTicket(
        ...
        val action =
            MechanicInRepairTicketsFragmentDirections.actionMechanicInRepairTicketsFragmentToMechanicCreateTicketFragment(
                machineId,
                machine,
                station,
                mfgLine,
    ...
    private fun navigateToReplace(
        ...
        val action = MechanicInRepairTicketsFragmentDirections
            .actionMechanicInRepairTicketsFragmentToReplaceMachineScanDetailsFragment(
                mfgLineId,
                mfgLine,
                station,
                machine,
    ...
    private fun navigateToMoveMachine(
        ...
        val action = MechanicInRepairTicketsFragmentDirections
            .actionMechanicInRepairTicketsFragmentToMoveMachineFragment(
                machineId,
                machine,
                rfid,
                subType,
    ...
    private fun navigateToQueryMachine(machineId: Long, machine: String) {
        val action = MechanicInRepairTicketsFragmentDirections
            .actionMechanicInRepairTicketsFragmentToQueryMachineFragment(machineId, machine)
        navigate(action)
    }
}
