...
class LineLeaderMachineProblemsAdapter constructor(val viewModel: CreateTicketViewModel, val ticketViewModel: TicketViewModel)
    : RecyclerView.Adapter<LineLeaderMachineProblemsAdapter.ViewHolder>(), Filterable {
