...
class MechanicInRepairTicketsListAdapter constructor(
    val viewModel: MechanicInRepairTicketsViewModel,
    val languageJsonObject: JSONObject
)
    : RecyclerView.Adapter<MechanicInRepairTicketsListAdapter.ViewHolder>() {
