...
import co.ltlabs.ltmechanic.databinding.FragmentMechanicReportedTicketsChecklistBinding
 ...
 */
class MechanicReportedTicketsChecklistFragment : DaggerFragment() {
    ...
    private val viewModel: MechanicReportedTicketsChecklistViewModel by lazy {
        ViewModelProvider(this, providerFactory).get(MechanicReportedTicketsChecklistViewModel::class.java)
    }
    ...
    private val args: MechanicReportedTicketsChecklistFragmentArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        val binding = FragmentMechanicReportedTicketsChecklistBinding.inflate(inflater)
...
//                    viewModel.sendNotificationToMechanics("Bearer ${it[0].token}", "clare", "New repaired ticket", "A ticket has been repaired.")
    ...
    private fun navigateToReportedList() {
        val action = MechanicReportedTicketsChecklistFragmentDirections
            .actionMechanicReportedTicketsChecklistFragmentToMechanicReportedTicketsFragment()
        navigate(action)
    }
