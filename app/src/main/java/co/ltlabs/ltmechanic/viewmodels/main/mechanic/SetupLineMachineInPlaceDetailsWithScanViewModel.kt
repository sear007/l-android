...
private const val TAG = "DetailsWScanViewModel";

class SetupLineMachineInPlaceDetailsWithScanViewModel @Inject constructor(private val machineApi: MachineApi) : ViewModel() {
