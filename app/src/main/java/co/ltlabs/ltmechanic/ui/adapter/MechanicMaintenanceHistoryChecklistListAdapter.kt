...
import co.ltlabs.ltmechanic.databinding.ListItemMaintenanceHistoryChecklistBinding
...
class MechanicMaintenanceHistoryChecklistListAdapter constructor(
//    val viewModel: MaintenanceHistoryChecklistViewModel
)
    : RecyclerView.Adapter<MechanicMaintenanceHistoryChecklistListAdapter.ViewHolder>() {
...
//            }
//
//            viewModel.updateChecklists(data)
//
...
//        }
    ...
    class ViewHolder private constructor(val binding: ListItemMaintenanceHistoryChecklistBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        companion object {
            fun from(parent: ViewGroup): ViewHolder {
                ...
                val binding = ListItemMaintenanceHistoryChecklistBinding.inflate(layoutInflater, parent, false)
