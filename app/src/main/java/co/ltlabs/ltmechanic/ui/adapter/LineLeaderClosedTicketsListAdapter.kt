...
class LineLeaderClosedTicketsListAdapter constructor(
    val viewModel: LineLeaderRepairedTicketsViewModel,
    val languageJsonObject: JSONObject
)
    : RecyclerView.Adapter<LineLeaderClosedTicketsListAdapter.ViewHolder>() {

    var index = -1
    var data = listOf<ClosedTicket>()
        set(value) {
            field = value
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        parent.setOnClickListener {
            viewModel.setNavigateToClosedTicketPreview(item)
        }
